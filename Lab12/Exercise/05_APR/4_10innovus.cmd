...
#  Created on Fri Dec  6 16:40:11 2024
#
#######################################################
...
addRing -nets {VCC GND} -type core_rings -follow core -layer {top metal3 bottom metal3 left metal2 right metal2} -width {top 9 bottom 9 left 9 right 9} -spacing {top 0.28 bottom 0.28 left 0.28 right 0.28} -offset {top 1.8 bottom 1.8 left 1.8 right 1.8} -center 1 -threshold 0 -jog_distance 0 -snap_wire_center_to_grid None -use_wire_group 1 -use_wire_group_bits 5 -use_interleaving_wire_group 1
setDrawView fplan
zoomBox -1743.98900 -389.77600 5109.59100 3163.04300
zoomBox -1434.31800 -271.84900 4391.22500 2748.04700
